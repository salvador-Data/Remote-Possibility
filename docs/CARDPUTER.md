...
Download the latest **`firmware.bin`** from GitHub Releases:

`https://github.com/salvador-Data/Remote-Possibility/releases/latest/download/firmware.bin`

Rename or install as `remote_possibility.bin` when sideloading through M5 OS. Check the manifest **sha256** field before OTA flash.
